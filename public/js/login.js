const form = document.querySelector(".formulaire"),
    continueBtn = document.querySelector(".formulaire input[type='submit']"),
    erreur = document.querySelector(".erreur"),
    mdp = document.getElementById("floatingInputGroup2"),
        ...
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                ...
                if (data === "Admin") {
                    ...
                    erreur.innerHTML = "<i class='fa-solid fa-xmark' onclick='masquer()' id='fermer'></i><span><i class='fa-solid fa-triangle-exclamation'></i>" + data + "</span>"
